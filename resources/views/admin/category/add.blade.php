...
<div class="max-w-4xl mx-auto">
    <div class="flex items-center gap-4 mb-8">
        ...
        <div>
            <h1 class="font-playfair text-3xl font-bold text-vintage-900">Thêm Danh Mục Mới</h1>
            <p class="text-stone-500 text-sm">Khởi tạo một bộ sưu tập tuyệt phẩm mới</p>
        </div>
    </div>
    ...
    <form action="{{ route('admin.categories.store') }}" method="POST" class="space-y-8">
        ...
        <div class="bg-white rounded-3xl p-8 shadow-sm border border-vintage-200 space-y-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" name="slug" id="slug" readonly
                        ...
                        placeholder="gom-su-trieu-nguyen">
                </div>
            </div>
            ...
            <div class="space-y-2">
                ...
                <textarea name="description" rows="4"
                    ...
                    placeholder="Giới thiệu đôi nét về những tuyệt phẩm trong danh mục này..."></textarea>
            </div>
        ...
        <div class="flex flex-col sm:flex-row items-center justify-end gap-4">
            <button type="reset" class="w-full sm:w-auto px-8 py-4 text-stone-400 font-bold hover:text-stone-600 transition-all uppercase tracking-widest text-[10px]">Hủy bỏ</button>
