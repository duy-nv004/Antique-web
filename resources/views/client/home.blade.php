                ...
                @foreach($products as $product)
                    <div class="col-lg-3 col-md-4 col-sm-6 mix">
                        <div class="featured__item">
                            @php
                                // Lấy ảnh chính, nếu không có thì dùng ảnh mặc định để tránh lỗi
                                $imagePath = $product->mainImage ? $product->mainImage->image_path : 'default.jpg';
                            @endphp

                            <div class="featured__item__pic set-bg"
                                style="background-image: url('{{ asset('storage/' . $imagePath) }}');"
                                data-setbg="{{ asset('storage/' . $imagePath) }}">
